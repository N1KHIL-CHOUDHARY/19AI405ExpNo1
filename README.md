...
agent.sensors = health_sensors
agent.actuators = health_actuators

agent.monitor_health()
```
## OUTPUT :

<img width="913" height="651" alt="image" src="https://github.com/user-attachments/assets/5613a3fc-0a15-4c91-886c-2b809d5af9fb" />
